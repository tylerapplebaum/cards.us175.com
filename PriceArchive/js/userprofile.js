...
var appClientId = "16vg3svrga8ip35dlrq95gk6la";
var userPoolId = "us-east-2_xrkh6kaWg";
var redirectURI = "https://dev.txn.us175.com/PriceArchive/";
console.log(redirectURI);

//Convert Payload from Base64-URL to JSON
const decodePayload = payload => {
  //globalThis.cognitoJWTb64 = payload
  //console.log("jwtb64", cognitoJWTb64)
...
async function main() {
  ...
  .then((data) => {
    ...
    tokens=data;
	//////////////////////////////////////
	// globalThis.completeToken = tokens
	...
	// Create variable for use in Fetch requests
	globalThis.cognitoJWT = tokens
	console.log(cognitoJWT);
	//
	globalThis.cognitoIdToken = tokens.id_token
	console.log(cognitoIdToken);
	//
	globalThis.cognitoAccessToken = tokens.access_token
	console.log(cognitoAccessToken);
	//
	//cognitoAccessToken = btoa(tokens.access_token);
	//console.log(cognitoAccessToken);
	// console.log("global", globalThis.cognitoAccessCode);
  });
